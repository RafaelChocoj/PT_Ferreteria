...
class ProductoDetalle(models.Model):
    ...
    def __str__(self):
        texto = "{0} - {1}"
        return texto.format(self.producto, self.bodega)
...
class CompraDetalle(models.Model):
    ...
    productodetalle = models.ForeignKey(ProductoDetalle, on_delete=models.PROTECT)
    productomedidas = models.ForeignKey(ProductoMedidas, on_delete=models.PROTECT, null=True)
